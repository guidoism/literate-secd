...
void validate_sel_implementation() @+ {
    <<make_tests(mem=sel-memory, positions=sel-before)>>
    s = 30;
    e = 0;
    c = 7;
    f = 38;
    index w = popc();
    assert(getnumber2(mem[w]) == 8); // SEL
    sel();
}                              
...
#+name: sel-before
| C | 3 |  5 |    | 7 |  9 |    |    |    | 16 |    |    |    | 23 | S | 30 |    |    |
|   | 4 |  6 | 51 | 8 | 10 | 12 |    | 14 | 17 | 19 |    | 21 | 24 |   | 31 |    |    |
|   |   | 50 |    |   | 11 | 13 | 53 | 15 | 18 | 20 | 55 | 22 |    |   | 32 | 34 | 36 |
|   |   |    |    |   |    | 52 |    |    |    | 54 |    |    |    |   | 33 | 35 | 37 |
